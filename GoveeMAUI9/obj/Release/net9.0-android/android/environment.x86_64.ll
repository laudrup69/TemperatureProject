...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 102, ; uint32_t number_of_shared_libraries
...
@aot_dso_cache = dso_local local_unnamed_addr global [855 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.92_name, ; name: libaot-System.Threading.Channels.dll.so
		ptr null; void* handle
	}, ; 2
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.95_name, ; name: libaot-System.Web.HttpUtility.dll.so
		ptr null; void* handle
	}, ; 20
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.77_name, ; name: libaot-System.Net.WebProxy.dll.so
		ptr null; void* handle
	}, ; 21
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.52_name, ; name: libaot-Xamarin.KotlinX.Serialization.Core.Jvm.dll.so
		ptr null; void* handle
	}, ; 51
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x15c427d845e2917d, ; from name: MQTTnet.dll.so
		i64 u0xe6648218caac06c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle
	}, ; 88
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.76_name, ; name: libaot-System.Net.WebHeaderCollection.dll.so
		ptr null; void* handle
	}, ; 205
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x47645c8068c4b092, ; from name: libaot-MQTTnet.so
		i64 u0xe6648218caac06c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x51e0861c98bad703, ; from name: libaot-MQTTnet
		i64 u0xe6648218caac06c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x660d952e1390cf5b, ; from name: aot-MQTTnet.dll.so
		i64 u0xe6648218caac06c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7e9b30163bb89ad6, ; from name: GoveeMAUI.so
		i64 u0x82c45e031dbf1c82, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GoveeMAUI.dll.so
		ptr null; void* handle
	}, ; 403
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x80180013a61fc5fe, ; from name: aot-GoveeMAUI
		i64 u0x82c45e031dbf1c82, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GoveeMAUI.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x82c45e031dbf1c82, ; from name: libaot-GoveeMAUI.dll.so
		i64 u0x82c45e031dbf1c82, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GoveeMAUI.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8753ce2e64307a39, ; from name: MQTTnet
		i64 u0xe6648218caac06c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8f947fe6c38235b2, ; from name: aot-GoveeMAUI.dll.so
		i64 u0x82c45e031dbf1c82, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GoveeMAUI.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x9f8f20a2e20a40d6, ; from name: libaot-GoveeMAUI.so
		i64 u0x82c45e031dbf1c82, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GoveeMAUI.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa033e7e9947e6127, ; from name: GoveeMAUI
		i64 u0x82c45e031dbf1c82, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GoveeMAUI.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb4fca74d58f44316, ; from name: libaot-GoveeMAUI
		i64 u0x82c45e031dbf1c82, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GoveeMAUI.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xbae3414f50424319, ; from name: MQTTnet.so
		i64 u0xe6648218caac06c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc2bf07a986accb14, ; from name: aot-MQTTnet
		i64 u0xe6648218caac06c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd7f053b92a2bf475, ; from name: aot-MQTTnet.so
		i64 u0xe6648218caac06c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe6648218caac06c2, ; from name: libaot-MQTTnet.dll.so
		i64 u0xe6648218caac06c2, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe924415364a7d4bc, ; from name: aot-GoveeMAUI.so
		i64 u0x82c45e031dbf1c82, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GoveeMAUI.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xee8fab6b666e98a9, ; from name: GoveeMAUI.dll.so
		i64 u0x82c45e031dbf1c82, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GoveeMAUI.dll.so
		ptr null; void* handle
...
@dso_apk_entries = dso_local local_unnamed_addr global [102 x %struct.DSOApkEntry] zeroinitializer, align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"com.personal.goveetempcontrol\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [24 x i8] c"libaot-GoveeMAUI.dll.so\00", align 16
...
@.DSOCacheEntry.23_name = private unnamed_addr constant [22 x i8] c"libaot-MQTTnet.dll.so\00", align 16
...
@.DSOCacheEntry.52_name = private unnamed_addr constant [53 x i8] c"libaot-Xamarin.KotlinX.Serialization.Core.Jvm.dll.so\00", align 16
...
@.DSOCacheEntry.76_name = private unnamed_addr constant [45 x i8] c"libaot-System.Net.WebHeaderCollection.dll.so\00", align 16
@.DSOCacheEntry.77_name = private unnamed_addr constant [34 x i8] c"libaot-System.Net.WebProxy.dll.so\00", align 16
...
@.DSOCacheEntry.92_name = private unnamed_addr constant [40 x i8] c"libaot-System.Threading.Channels.dll.so\00", align 16
...
@.DSOCacheEntry.95_name = private unnamed_addr constant [37 x i8] c"libaot-System.Web.HttpUtility.dll.so\00", align 16
