...
@dso_apk_entries = dso_local local_unnamed_addr global [102 x %struct.DSOApkEntry] zeroinitializer, align 8
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"com.personal.goveetempcontrol\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [24 x i8] c"libaot-GoveeMAUI.dll.so\00", align 1
...
@.DSOCacheEntry.23_name = private unnamed_addr constant [22 x i8] c"libaot-MQTTnet.dll.so\00", align 1
...
@.DSOCacheEntry.52_name = private unnamed_addr constant [53 x i8] c"libaot-Xamarin.KotlinX.Serialization.Core.Jvm.dll.so\00", align 1
...
@.DSOCacheEntry.76_name = private unnamed_addr constant [45 x i8] c"libaot-System.Net.WebHeaderCollection.dll.so\00", align 1
@.DSOCacheEntry.77_name = private unnamed_addr constant [34 x i8] c"libaot-System.Net.WebProxy.dll.so\00", align 1
...
@.DSOCacheEntry.92_name = private unnamed_addr constant [40 x i8] c"libaot-System.Threading.Channels.dll.so\00", align 1
...
@.DSOCacheEntry.95_name = private unnamed_addr constant [37 x i8] c"libaot-System.Web.HttpUtility.dll.so\00", align 1
